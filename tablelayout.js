...
let table = document.getElementById('tablelayoutin');
let table3 = table.innerHTML;
...
// for (let p = 0; p = usersData.length; p++) {
//   data += `<tr>
//               <td> ${usersData[p].id}</td>
//               <td>${usersData[p].title}</td>
//               <td>${usersData[p].body}</td>
//               </tr>`
// }
document.getElementById("tablelayouts").innerHTML = table3 + data;